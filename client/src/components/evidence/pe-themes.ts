...
export const BUILTIN_PE_THEMES: ThemeConfig[] = [
  ...
  {
    id: 'builtin-sky-light', name: 'الأزرق الفاتح',
    layoutType: 'white-header-light',
    headerBg: '#ffffff', headerText: '#075985',
    accent: '#0284C7', borderColor: '#7DD3FC',
    titleBg: '#E0F2FE', fieldLabelBg: '#F0F9FF',
    footerBg: '#075985',
    tableStyle: false, titleStyle: 'bordered', showTopLine: true, showBottomBar: true,
    fieldStyle: 'fieldset', signatureStyle: 'solid',
    coverStyle: 'split-left', sectionCoverStyle: 'left-stripe', coverAccent2: '#38BDF8',
    headerVariant: 'center-logo-banner',
    headerSeparator: true,
    bodyBg: '#F0F9FF',
  },
  {
    id: 'builtin-sidebar-teal', name: 'الشريط الجانبي',
    layoutType: 'white-header-sidebar',
    headerBg: '#ffffff', headerText: '#134E4A',
    accent: '#0F766E', borderColor: '#5EEAD4',
    titleBg: '#0F766E', fieldLabelBg: '#F0FDFA',
    footerBg: '#134E4A',
    tableStyle: false, titleStyle: 'badge', showTopLine: false, showBottomBar: true,
    fieldStyle: 'cards', signatureStyle: 'boxed',
    coverStyle: 'framed-elegant', sectionCoverStyle: 'card-center', coverAccent2: '#2DD4BF',
    headerVariant: 'right-text-left-logo',
    headerSeparator: true,
    bodyBg: '#F8FAFC',
    sidebarBg: '#134E4A',
